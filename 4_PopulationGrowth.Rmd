...
So: At $t_0$ the slope = 2x2 = 4. At $t_3$ the slope = 2x16 = 32. Etc
]
...
We can build SDMs based on demographic models that estimate population growth based on environmental conditions.
