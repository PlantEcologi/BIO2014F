...
In some species, individuals need to be close together to find mates. In these cases, the population growth rate is positively correlated with population density. This is a huge problem for species of conservation concern, where populations have become small and isolated.

It is believed that this may be a factor in the decline of species like the Clanwilliam cedar (_Widdingtonia cedarbergensis_), which is endemic to the Cedarberg mountains of South Africa. The trees are wind-pollinated, but they are also self-incompatible, meaning that they need to cross-pollinate with other trees to produce seeds. This means that if the population density is too low, there may not be enough pollen available to fertilize the ovules.

Other examples of Allee effects include **cooperative feeding** and **predator satiation**.
]
