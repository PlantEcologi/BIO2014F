...
Utilise the concepts proposed by Grinnell and Hutchinson to predict the geographic distribution (or range) of species.
...
Statistical models are necessarily simplifications of reality, and their predictions always come with some error (i.e. there is uncertainty). 
...
- biases in the occurrence data 
    - easy-to-access areas are usually overrepresented
- quality of the occurrence and environmental data...
    - GIGO (garbage in - garbage out)
- the type and structure of the statistical model...

Ideally one quantifies and report the uncertainty for your model, but that is a topic for [**BIO3019S**](https://science.uct.ac.za/department-biological-sciences/undergraduate-study/third-year-courses)...
...
### SDMs and the assumption of equilibrium?
...
B) If a species is in a non-equilibrium distribution, its potential niche is not fully occupied due to dispersal constraints or seasonal or long-term dynamism of habitats.
...
### Invasive species and the assumption of equilibrium
...
The _Enemy release hypothesis_ - invasive species are less impacted by enemies than native species, because in the new geographical location, invasive species are freed from the enemies that kept their growth in check in their native environment.

> *"we used a previously parameterized mechanistic model to make predictions of the fundamental niche of* R. marina *[by linking] microclimatic condition estimates derived from long-term weather station data with biophysical and physiological constraints on the eggs, larvae, and adults ... to predict the potential number of breeding months per year."*
