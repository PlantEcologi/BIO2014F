...
- the type and structure of the model, e.g.
    - statistical vs mechanistic, continuous (abundance) vs discrete (presence/absence), frequentist vs Bayesian
--
...
- quality of the occurrence and environmental data... - GIGO (garbage in - garbage out)
    ...
    - biases in the occurrence data 
      - easy-to-access areas are usually over-represented (e.g. near roads or paths)
...
How this is done with Protea species?
