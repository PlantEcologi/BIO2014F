...
This definition focuses on the organism's role or **function** in the ecosystem.
...
Since Charles Elton was mostly working with animals, his focus was largely on trophic position (consumers, predators, etc), but this can be expanded to plants and other life forms.
  - Generally the focus is on **resource use**.
...
.pull-right[
.footnote[*Dispersal component covered in later lectures]
]
---
class: middle
...
>*Hutchinson proposed the n-dimensional hypervolume as a means to quantify the niche. He also made a distinction between the fundamental and realised niches.*

---

## The module from here...

1. Introduction to Niche Theory
2. Defining the Niche
3. Geographic distributions and Niche modelling
