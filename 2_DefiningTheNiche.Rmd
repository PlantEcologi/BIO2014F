...
What's the difference between Grinnell's niche conception of the niche and "habitat"?
...
e.g. the California thrasher's "niche" is defined by the matching of its behavior and physical traits (camouflage, wings and leg size and shape, etc) with this habitat.
...
This proposition both aids our ability to think about the niche, but also allows us to explicitly **quantify the niche and niche space**.
...
The _n-dimensional hypervolume_ is a multidimensional space of ecological variables within which a species can maintain a viable population. This example shows 2 dimensions, minimum and maximum temperature.
