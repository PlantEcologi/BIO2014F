...
e.g. "Vagrant" birds are typically outside their niche - they are not able to reproduce there.
...
E.g. Light availability can be an abiotic environmental condition (e.g. incoming solar radiation, varying by aspect) or a biotically alterable limiting resource (e.g. light competition among plants)...
