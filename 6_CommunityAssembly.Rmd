...
Eventually, the less flammable forest species will exclude fire, and the necessary cues for most Fynbos species to recruit. They're also altering the soils and light environment, shifting the environmental filter for new species and selecting for forest species.
...
.pull-left[
Slides 9 - 12 suggest that community assembly is a deterministic process... (as we've tried to illustrate here)
...
While it may be predictable, we haven't worked out quite how to predict it accurately yet and there are many mysteries, contrasting theories and concepts, and consequent raging debates: Eltonians vs Grinnellians, Gleasonians vs Clementsians, etc
...
Niche Theory assumes _a priori_ that ecological communities are inherently high-dimensional _sensu_ Hutchinson's (1957) hypervolume.
...
The "neutrality assumption" is that species are viewed as functionally equivalent
