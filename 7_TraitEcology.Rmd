...
> _"...this can be achieved but that community ecology has lost its way by focusing on pairwise species interactions independent of the environment."_
...
Related inter- and intraspecific variation in 11 functional traits to measures of the Hutchinsonian niches of 26 Proteaceae species in the Cape Floristic Region.
...
Built demographic models to estimate 3 measures of the fundamental Hutchinsonian niche ( $r_{max}$, niche optima and niche breadth) for each of 5 environmental variables (aridity, minimum and maximum temperature, soild fertility and fire interval) for the 26 species.
...
A note on selecting the right traits
...
[**Chapin et al 1997**](http://dx.doi.org/10.1126/science.277.5325.500)
