...
### Remember r vs K-selected species?

.pull-left[
```{r echo = F, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("images/celiwe_rk1.png")
```
]

.pull-right[
```{r echo = F, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("images/celiwe_rk2.png")
```
]
.footnote[from Celiwe's lecture on life history models]
...
**Note:** _Where $N$ is small, the logistic growth curve approximates the exponential growth curve $(rN)$, because the term $(K – N)/K$ is close to 1. It begins to deviate as $N$ increases and the term tends to zero._
]
...
Empirical datasets showed evidence for a negative impact of density on:
...
### What factors other than competition could cause density-dependence? 
