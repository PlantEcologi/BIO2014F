...
```{r echo = F, fig.align = 'center', out.width = '67%'}
...
Since biomes are largely defined by dominant plant functional types (PFT), we could model biomes by aggregating species distributions to PFT and assigning biomes based on PFT combinations.
