...
[**Chesson 2000**](https://doi.org/10.1146/annurev.ecolsys.31.1.343) proposed a new framework for understanding coexistence, based on **niche differences** and **fitness differences** (differences in competitive ability). Larger competitive ability differences favor competitive exclusion, while larger niche differences promote coexistence.
...
He distinguished between two types of mechanisms that promote coexistence by affecting each of these factors:
...
_Equalizing_ mechanisms, which reduce the differences in population growth rates between species (i.e. _fitness differences_). The argument is that these mechanisms are not niche differences, but rather _differences in the competitive ability_ of species.
...
- These effects reduce the impact of fitness differences, effectively making all species equal competitors and facilitating coexistence even where niche differences (stabilizing mechanisms) are small.
