...
Georgyi Frantsevitch Gause's experiments with species of the unicellular cilliate genus _Paramecium_ taught us a lot about intra- and interspecific competition.

<br>

He cultured them in test tubes supplied with an oatmeal medium, which promotes the growth of bacteria in the upper, oxygenated part of the test tube, and yeast in the lower, de-oxygenated part of the test tube.
]
...
_Paramecium_ species cultured separately, demonstrating **_intraspecific_** competition.
...
_Paramecium_ species cultured together, demonstrating **_interspecific_** competition.
...
**Right:** While _P. caudatum_ out-competes _P. bursaria_ for bacteria, _P. bursaria_ can survive on yeast in the lower, less oxygenated part of the test tube, because it contains tiny green algae that provide it with oxygen. This is an example of **resource partitioning**.
...
### The potential outcomes of competition

1. Competitive exclusion
  - and extinction of one competitor
  - spatial segregation of competitors (i.e. the species do not coexist locally, but occur in sympatry)
...
.footnote[The Atlas of World Wildlife (not MacArthur's warblers...)]
]
...
Size and shape of the bill and facial stripe in Sitta neumayer and S. tephronota. A and B are collections of the respective species where they occur alone. D and C were collected where they co-occur.
...
Unequivocal examples of competitive exclusion are rare, and can only be demonstrated with experiments such as Gause's. These experiments are near-impossible for organisms with longer lifespans.
...
In nature, while interspecific competition may be common, where competitive exclusion has occurred it cannot be observed - only one competitor would remain.
...
### How can we determine which species can coexist?
