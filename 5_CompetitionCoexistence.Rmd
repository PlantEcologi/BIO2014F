---
title: "5. Interspecific Competition and Coexistence"
subtitle: ""  
author: 
...
**Right:** While _P. caudatum_ out-competes _P. bursaria_ for bacteria, _P. bursaria_ can survive on yeast in the lower, less oxygenated part of the test tube, because it contains tiny green algae that provide it with oxygen. We call this **resource (or niche) partitioning**.
...
- Notice that the size of $N_2$ at this point depends on $\alpha_{12}$. $K_1$ is reached at lower $N_2$ when $\alpha_{12}$ is large (species 2 has a strong competitive effect).
